...
WebUI.callTestCase(findTestCase('Demo1/Log in'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Ravi'))
